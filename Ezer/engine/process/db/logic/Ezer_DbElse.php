 ...
 */
class Ezer_DbElse extends Ezer_Else
{
	/**
	 * @var Ezer_IntElse
	 */
	...
	public function __construct(Ezer_IntElse $sequence)
	{
	...
	public function load(Ezer_IntElse $sequence)
	{
	...
	public function &createInstance(Ezer_ScopeInstance &$scope_instance)
	{
		...
		$ret = new Ezer_DbElseInstance($dbInstance, $scope_instance, $this);
		return $ret;
	}
}
